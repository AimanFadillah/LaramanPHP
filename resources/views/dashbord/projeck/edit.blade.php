...
<form action="/dashbord/projeck/{{ $projeck->slug }}" method="POST" enctype="multipart/form-data" >
    @method('put')
    @csrf
    {{-- title --}}
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="hidden" name="oldImage" value="{{ $projeck->img }}" >
        @if($projeck->img)
        <img src="{{  asset('storage/' . $projeck->img )  }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
        @else
